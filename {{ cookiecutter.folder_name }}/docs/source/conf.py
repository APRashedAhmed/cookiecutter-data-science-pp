...
release = {{ cookiecutter.import_name }}.__version__
...
htmlhelp_basename = '{{ cookiecutter.folder_name }}doc'
...
man_pages = [
    ('index', '{{ cookiecutter.folder_name }}', u'{{ cookiecutter.project_name }} Documentation',
